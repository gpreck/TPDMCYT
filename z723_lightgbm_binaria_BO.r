...
#         makeIntegerParam("envios",           lower= 5000L   , upper= 15000L)
         makeIntegerParam("envios",           lower= 9000L   , upper= 10000L)
        )
...
PARAM$trainingstrategy$semilla_azar   <- 804383  #Aqui poner la propia semilla
...
PARAM$hyperparametertuning$semilla_azar  <- 804409  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy
...
dir.create( "./exp/",  showWarnings = FALSE ) 
dir.create( "./exp/HT7231/", showWarnings = FALSE )
setwd("./exp/HT7231/")   #Establezco el Working Directory DEL EXPERIMENTO
