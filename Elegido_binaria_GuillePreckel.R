...
setwd("C:/Users/gpreckel/Desktop/Guille/Maestria/4. DMEyF")  #Establezco el Working Directory
...
#dtrain [ ,n1 := as.integer (mactivos_margen/mpasivos_margen) ]
#dapply [ ,n1 := as.integer (mactivos_margen/mpasivos_margen) ]

#dtrain[ ,n1 :=  ifelse( mpasivos_margen>0, mactivos_margen/mpasivos_margen, 0 ) ]
#dapply[ ,n1 :=  ifelse( mpasivos_margen>0, mactivos_margen/mpasivos_margen, 0 ) ]
...
modelo  <- rpart(formula=   "clase_binaria ~ . -clase_ternaria",
                 ...
                 xval=         0, #0,
                 cp=          -0.54,# -0.51 -0.54, -0.89
                 minsplit=  1073,   # 850, 1073, 621
                 minbucket=  278,   # 354, 278,309
                 maxdepth=     9 )  # 7,9, 12
...
#for( corte  in  c( 9500, 9600, 9700, 9800,9900, 10000) )
#for( corte  in  c( 9470,9480,9485,9490,9495) )
for( corte  in  c(9485,9490,9495,9500) )  
{
  ...
  fwrite( dfinal[ , list(numero_de_cliente, Predicted) ], #solo los campos para Kaggle
           file= paste0( "./exp/KA4120_6/KA4120_005_",  corte, ".csv"),
           sep=  "," )
}
