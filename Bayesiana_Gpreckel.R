...
hs  <- makeParamSet(
          ...
          makeNumericParam("minsplit" , lower=   400,   upper= 1500 ),
          makeNumericParam("minbucket", lower=   200,   upper= 500 ),
          makeIntegerParam("maxdepth" , lower=   6L,  upper=   18L),  #la letra L al final significa ENTERO
